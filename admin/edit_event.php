  ...
  <div class="row">
   ...
   <div class="icons-box-vert-container">
    ...
    <div class="span12">
     ...
     <form  action="update_event.php<?php echo "?id=$id"; ?>" method="post">
      ...
      <input type="date" value="<?php echo "$when"; ?>" name="date" ><br>
      <br>
      <label for="">limit</label>
      <input type="number" value="<?php echo "$limit"; ?>" name="limit" ><br>
      <br>
